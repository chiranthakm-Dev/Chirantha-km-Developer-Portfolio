...
const EasterEggs = () => {
  ...
  useEffect(() => {
    ...
    if (typeof console !== "undefined") {
      ...
      ["chirantha", "Chirantha", "CHIRANTHA", "chirantha k m", "Chirantha K M"].forEach((name) => {
        // @ts-ignore
        ...
        Object.defineProperty(window, name, {
          get() {
            console.log(
              "%c✨ Abra Kadabra! ✨\n\n" +
                "You just summoned the magic of Chirantha K M! 🧙‍♂️\n" +
                "What??? you're not impressed? Remember: With great power comes great responsibility! 💻⚡",
